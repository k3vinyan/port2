            ...
            <div className={ProjectStyles.secondColumn}>
                <div>
                    <div className={ProjectStyles.projectContainer} >
                        <div><h1 className={ProjectStyles.positionTitle}>DSF3-Flex | Full Stack</h1></div>
                    ...
                    <div className={ProjectStyles.projectContainer} >
                        <div><h1 className={ProjectStyles.positionTitle}>Hack1n-Slash | Front End</h1></div>
                    ...
                    <div className={ProjectStyles.projectContainer} >
                        <div><h1 className={ProjectStyles.positionTitle}>Car Wars | Full Stack</h1></div>
